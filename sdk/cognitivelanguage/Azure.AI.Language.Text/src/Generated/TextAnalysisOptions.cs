...
{
    /// <summary> Client options for <see cref="TextAnalysis"/>. </summary>
    public partial class TextAnalysisOptions : ClientOptions
    {
        private const ServiceVersion LatestVersion = ServiceVersion.V2025_11_15_Preview;

        /// <summary> Initializes a new instance of TextAnalysisOptions. </summary>
        /// <param name="version"> The service version. </param>
        public TextAnalysisOptions(ServiceVersion version = LatestVersion)
        {
