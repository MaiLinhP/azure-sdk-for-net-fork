...
{
    internal partial class UnknownEntityOverlapPolicy : EntityOverlapPolicy, IJsonModel<EntityOverlapPolicy>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownEntityOverlapPolicy DeserializeUnknownEntityOverlapPolicy(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownEntityOverlapPolicy(policyKind, additionalBinaryDataProperties);
        }
