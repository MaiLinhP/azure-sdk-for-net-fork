...
namespace Azure.AI.Language.Text
{
    ...
    public partial class HealthcareLROTask : AnalyzeTextOperationAction, IJsonModel<HealthcareLROTask>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<HealthcareLROTask>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HealthcareLROTask IJsonModel<HealthcareLROTask>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (HealthcareLROTask)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HealthcareLROTask DeserializeHealthcareLROTask(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new HealthcareLROTask(name, kind, additionalBinaryDataProperties, parameters);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HealthcareLROTask>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HealthcareLROTask IPersistableModel<HealthcareLROTask>.Create(BinaryData data, ModelReaderWriterOptions options) => (HealthcareLROTask)PersistableModelCreateCore(data, options);
